...
//		(void*)set_target_speed,"void set_target_speed(uint16_t speed)",
//		(void*)pid_change,"void pid_change(uint16_t num,uint16_t p,uint16_t i,uint16_t d)",
		(void*)pid_changep,"void pid_changep(uint16_t p_in)",
		(void*)pid_changei,"void pid_changei(uint16_t i_in)",
		(void*)pid_changed,"void pid_changed(uint16_t d_in)",
